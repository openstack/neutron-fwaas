...
class FireWallDriverDBMixinTestCase(test_fwaas_plugin_v2.
    ...
    def setUp(self):
        ...
        self.mock_registry_publish = mock.patch(
            'neutron_lib.callbacks.registry.publish').start()
        self.driver_api = self.plugin.driver
        self.ctx = context.get_admin_context()
        self.firewall_db = self.plugin.driver.firewall_db
        self.m_payload = mock.Mock()
        m_db_event_payload = mock.patch(
            'neutron_lib.callbacks.events.DBEventPayload').start()
